...
## Installation
  ...
  5. Run `ansible-playbook main.yml --ask-become-pass --ask-vault-pass` inside this directory. Enter your macOS account password when prompted for the 'BECOME' password.
